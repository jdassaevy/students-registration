(function (root) {
    ...
    style.textContent = `
    .financial-row-clickable{cursor:pointer;transition:background-color var(--motion-fast) ease,transform var(--motion-fast) ease}.financial-row-clickable:hover{background:var(--accent-soft)}.financial-row-clickable:active{transform:scale(.997)}
    .financial-row-name{display:flex;align-items:center;gap:8px}.financial-row-arrow{margin-left:auto;color:var(--accent-primary);font-weight:900}
    #financialDetailModal{width:min(920px,calc(100% - 28px));max-height:88vh;overflow:hidden;background:var(--surface-card);color:var(--text-primary);border:1px solid var(--border-default);box-shadow:var(--shadow-elevated)}
    .financial-detail-body{padding:0 24px 24px;max-height:calc(88vh - 92px);overflow:auto;color:var(--text-secondary)}.financial-detail-summary{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-bottom:16px}.financial-detail-summary>div{padding:14px;border:1px solid var(--border-default);border-radius:14px;background:var(--surface-elevated)}.financial-detail-summary span{display:block;color:var(--text-muted);font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.05em}.financial-detail-summary strong{display:block;margin-top:5px;color:var(--text-primary);font-size:18px}
    .financial-student-list{display:grid;gap:12px}.financial-student-card{padding:16px;border:1px solid var(--border-default);border-radius:16px;background:var(--surface-elevated);box-shadow:var(--shadow-card)}.financial-student-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;margin-bottom:13px}.financial-student-head strong{color:var(--text-primary);font-size:15px}.financial-student-head small{display:block;margin-top:3px;color:var(--text-muted)}.financial-student-total{white-space:nowrap;color:var(--status-success);font-weight:850}
    .financial-person-detail{display:grid;grid-template-columns:minmax(130px,1fr) minmax(120px,.7fr) minmax(210px,1.2fr) auto;gap:12px;align-items:center;padding:11px 0;border-top:1px solid var(--border-default)}.financial-person-detail:first-of-type{border-top:0}.financial-person-name strong{color:var(--text-primary);font-size:13px}.financial-person-name small{display:block;margin-top:3px;color:var(--text-muted);font-size:10px}.financial-entry-status{font-size:11px;font-weight:800}.financial-entry-status.ok{color:var(--status-success)}.financial-entry-status.bad{color:var(--status-danger)}.financial-month-statuses{display:flex;gap:6px;flex-wrap:wrap}.financial-month-chip{display:inline-flex;align-items:center;justify-content:center;min-width:32px;height:28px;padding:0 8px;border:1px solid transparent;border-radius:9px;font-size:10px;font-weight:850}.financial-month-chip.ok{background:color-mix(in srgb,var(--status-success) 16%,transparent);border-color:color-mix(in srgb,var(--status-success) 28%,transparent);color:var(--status-success)}.financial-month-chip.bad{background:color-mix(in srgb,var(--status-danger) 14%,transparent);border-color:color-mix(in srgb,var(--status-danger) 26%,transparent);color:var(--status-danger)}.financial-person-received{text-align:right}.financial-person-received small{display:block;color:var(--text-muted);font-size:9px;text-transform:uppercase}.financial-person-received strong{font-size:13px;color:var(--text-primary)}
