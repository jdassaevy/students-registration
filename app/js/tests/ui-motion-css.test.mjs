...
const tabBar = fs.readFileSync(new URL('../features/tab-bar.js', import.meta.url), 'utf8');
...
assert.match(css, /\.financial-stats \.stat:hover[\s\S]*translateY\(-5px\)/, 'financial stat cards should lift on hover');
...
for (const id of ['dashboardTab', 'studentsTab', 'financialTab', 'reportsTab', 'automationTab']) {
