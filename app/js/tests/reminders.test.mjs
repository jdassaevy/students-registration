...
assert.equal(reminderTypeForDate('2026-09-10', '2026-09-07'), 'reminder_before_due');
...
const student = {
  ...
  fees: { person1: { monthly: 250 }, person2: { monthly: 250 } },
  payments: { person1: [false, true, false], person2: [false, false, false] }
};
const clazz = { id: 'c1', name: 'Turma A', start_date: '2026-09-10' };
const academy = {
  academy_name: 'Academia A',
  responsible_name: 'Prof. Carlos',
  support_phone: '5548888888888'
};
const candidates = buildReminderCandidates({ student, clazz, academy, today: '2026-09-07' });
